...
points(artist_coords$artist.longitude, artist_coords$artist.latitude,
       pch = 21, bg = "#d73027", col = "#000000", cex = 0.6)
title(main = "Artist Locations (usable coordinates only)",
      sub = paste("Plotted artists:", n_artists, "— many artists have placeholder coordinates (0,0), limiting coverage."))
#
#
#
#
